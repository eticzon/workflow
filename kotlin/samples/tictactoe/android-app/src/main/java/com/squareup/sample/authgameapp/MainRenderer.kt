...
import com.squareup.viewregistry.toPanelContainerScreen
import com.squareup.workflow.Renderer
import com.squareup.workflow.WorkflowInput
import com.squareup.workflow.WorkflowPool
import com.squareup.workflow.render

typealias RootScreen = AlertContainerScreen<PanelContainerScreen<BackStackScreen<*>>>
  ...
  override fun render(
    ...
    return when (state) {
      ...
      is RunningGame -> {
        ...
        AlertContainerScreen(baseScreen.toPanelContainerScreen(), alerts)
      }
    }
  }
}
